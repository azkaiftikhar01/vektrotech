            ...
            >
              ...
              <div className={idx % 2 === 1 ? 'lg:order-2' : ''}>
                <div className="space-y-6">
                  <div>
                    ...
                    <h2 className="font-serif text-5xl font-bold text-navy mt-4 mb-2">
                      {project.name}
                    </h2>
              ...
              <div className={idx % 2 === 1 ? 'lg:order-1' : ''}>
                <motion.div
                  ...
                  className={`relative bg-gradient-to-br ${project.color} rounded-3xl shadow-2xl overflow-hidden`}
                >
                  {/* Browser Chrome */}
                  ...
                  {/* Screen Content */}
                  <div className="aspect-video bg-gradient-to-br from-white via-blue/5 to-purple/5 flex flex-col items-center justify-center p-8 text-center">
                    <div className="text-6xl mb-4">{project.icon}</div>
                    <h3 className="font-serif text-2xl font-bold text-navy mb-2">{project.name}</h3>
                    <p className="text-gray-600 text-sm max-w-xs">{project.tagline}</p>
                  </div>
